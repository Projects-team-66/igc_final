...
<div class="row justify-content-center mb-5">
    <form id="formularioReporte1" class="border shadow p-4 col-lg-10">
        ...
        <div class="row mb-3">
            <div class="col">
                <label for="reporte_asis_grado">Seleccione un Grado</label>
                <select name="reporte_asis_grado" id="reporte_asis_grado" class="form-control">
            ...
            <div class="col">
                ...
                <select name="reporte_asis_seccion" id="reporte_asis_seccion" class="form-control">
                    ...
                    <?php foreach ($secciones as $seccion) : ?>
                        <option value="<?= $seccion['seccion_id'] ?>"> <?= $seccion['seccion_nombre'] ?></option>';
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
