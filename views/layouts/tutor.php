                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                        ...
                        <div class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu" style="margin: 0;">
                                <li>
                                    <a class="dropdown-item nav-link text-white " href="/igc_final/notas"><i class="bi bi-person-plus"></i> Notas de Alumnos</a>
                                </li>
                                
                            </ul>
                        </div>
                    <div class="col-lg-1 d-grid mb-lg-0 mb-2">
                        <a href="/igc_final/logout" class="btn btn-danger"><i class="bi bi-arrow-bar-left"></i>CERRAR SESIÓN</a>
                    </div>
                </div>
            </div>
        </nav>
